...
await page.evaluate(()=>{const art=document.querySelector('.home-roamer-art');bounceCharacter(art);const img=art.querySelector('img');const a=img.getAnimations().find(a=>a.id==='character-bounce');if(a){a.pause();a.currentTime=270;}});
