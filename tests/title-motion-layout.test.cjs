...
await page.evaluate(()=>{const art=document.querySelector('.home-roamer-art');bounceCharacter(art);const actor=art.querySelector('.quest-actor');const a=actor.getAnimations().find(a=>a.id==='character-bounce');if(a){a.pause();a.currentTime=270;}});
